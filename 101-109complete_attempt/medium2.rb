...
# conditions for balanced_parentheses to be true :
#   cond1 : more than 0 parentheses &&
#   cond2 :equal number of "(" and ")" &&
#   cond3: when we iterate over each character from left to right, there's always more "(" than ")"
#          "abcd(nd)nd(nd)" 
